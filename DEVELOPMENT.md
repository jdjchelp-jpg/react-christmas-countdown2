...
```bash
git remote add encore encore://leap-app-2rgi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/leap-app-2rgi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/leap-app-2rgi/settings/integrations/github)
